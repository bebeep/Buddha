...
public class NodeGestureController {
    ...
    public void onOneFingerScroll(float distanceX, float distanceY) {
        synchronized (NodeGestureController.class){
            nodeGestureListener.onOneFingerScroll(distanceX,distanceY);
        }
    }
    ...
    /**
     * 仅允许水平方向上旋转
     * @param justHorizontalRotate
     * @return
     */
    public NodeGestureController setJustHorizontalRotate(boolean justHorizontalRotate)
    {
        nodeGestureListener.setJustHorizontalRotate(justHorizontalRotate);
        return this;
    }

    /**
     * 仅允许水平方向上旋转
     * @param justVerticalRotate
     * @return
     */
    public NodeGestureController setJustVerticalRotate(boolean justVerticalRotate)
    {
        nodeGestureListener.setJustVerticalRotate(justVerticalRotate);
        return this;
    }
