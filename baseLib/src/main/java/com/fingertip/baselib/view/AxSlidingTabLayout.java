...
public class AxSlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public AxSlidingTabLayout(Context context) {
        this(context, null, 0);
    }

    public AxSlidingTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AxSlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
