...
public class PhotoEntity implements Parcelable {
    ...
    public String uploadedUrl = "";//已上传的地址



    public PhotoEntity(String path, String type) {
        this.path = path;
        this.type = type;
    }
    public PhotoEntity(String name, Uri uri, String path, long time, int width, int height, int orientation, long size, long duration, String type) {
        this.name = name;
        this.uri = uri;
        this.path = path;
        this.time = time;
    ...
    public boolean equals(Object o) {
        try {
            PhotoEntity other = (PhotoEntity) o;
