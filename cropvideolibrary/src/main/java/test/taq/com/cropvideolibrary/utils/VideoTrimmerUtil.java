package test.taq.com.cropvideolibrary.utils;
...
public class VideoTrimmerUtil {
  ...
  public static final int VIDEO_MAX_TIME = 60;// 60秒
  ...
  private static final int THUMB_WIDTH = (SCREEN_WIDTH_FULL - RECYCLER_VIEW_PADDING * 2) / MAX_COUNT_RANGE;
