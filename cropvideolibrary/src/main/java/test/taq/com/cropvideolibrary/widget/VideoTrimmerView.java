package test.taq.com.cropvideolibrary.widget;
...
import test.taq.com.cropvideolibrary.R;
import test.taq.com.cropvideolibrary.adapter.VideoTrimmerAdapter;
import test.taq.com.cropvideolibrary.interfaces.IVideoTrimmerView;
import test.taq.com.cropvideolibrary.interfaces.VideoTrimListener;
import test.taq.com.cropvideolibrary.utils.VideoTrimmerUtil;

import static test.taq.com.cropvideolibrary.utils.VideoTrimmerUtil.VIDEO_FRAMES_WIDTH;
...
public class VideoTrimmerView extends FrameLayout implements IVideoTrimmerView {
  ...
  public void initVideoByURI(final Uri videoURI) {
    ...
    mVideoShootTipTv.setText(mContext.getString(R.string.DragHint));
    //String.format(mContext.getResources().getString(R.string.video_shoot_tip), VideoTrimmerUtil.VIDEO_MAX_TIME)
  }
  ...
  private void onSaveClicked() {
    if (mRightProgressPos - mLeftProgressPos < VideoTrimmerUtil.MIN_SHOOT_DURATION) {
      ...
      float start=mLeftProgressPos/1000;
      float duration =mRightProgressPos/1000-mLeftProgressPos / 1000;
      mOnTrimVideoListener.onStartTrim(start,duration);
    }
  }
  ...
  private void playingAnimation() {
    ...
    long duration = (mRightProgressPos - scrollPos) - (mRedProgressBarPos - scrollPos);
    if (duration > 0) {
      mRedProgressAnimator = ValueAnimator.ofInt(start, end).setDuration(duration);
