...
import static me.yokeyword.fragmentation.TransactionDelegate.TYPE_ADD_WITHOUT_HIDE;
...
public class SupportActivity extends AppCompatActivity implements ISupportActivity {
    ...
    public void start(ISupportFragment fromFragment, ISupportFragment toFragment) {
        mDelegate.start(fromFragment, toFragment);
    }
     ...
     * @param toFragment  目标Fragment
     */
    public void startRootFragment(@NonNull ISupportFragment toFragment) {
        start(getTopFragment(getSupportFragmentManager(), getMainContainerId()), toFragment);
    }

    public void startRootFragmentWithoutHide(@NonNull ISupportFragment toFragment) {
        startWithType(toFragment, TYPE_ADD_WITHOUT_HIDE);
    }

    public void bindContainerId(int containerId, ISupportFragment to) {
        mDelegate.bindContainerId(containerId, to);
    }
    ...
    public static ISupportFragment getTopFragment(FragmentManager fragmentManager, int containerId) {
        return SupportHelper.getTopFragment(fragmentManager, containerId);
    }
}
