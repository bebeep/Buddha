...
public class SupportFragment extends Fragment implements ISupportFragment {
    ...
    public void startWithType(ISupportFragment toFragment, int type) {
        mDelegate.startWithType(toFragment, type);
    }
    ...
    /**
     * 将当前fragment的containerId绑定在新fragment上
     */
    @Override
    public void bindContainerId(ISupportFragment to) {
        bindContainerId(mDelegate.mContainerId, to);
    }

    /**
     * 将containerId绑定在新fragment上
     */
    @Override
    public void bindContainerId(int containerId, ISupportFragment to) {
        mDelegate.mTransactionDelegate.bindContainerId(containerId, to);
    }
    ...
    @Override
    public void bindContainerId(int containerId, ISupportFragment... to) {
        for (ISupportFragment fragment : to) {
            bindContainerId(containerId, fragment);
        }
    }

    /****************************************hzz添加，直接跳转添加到根container******************************************************/

    /**
     * @param toFragment  目标Fragment
     */
    public void startActRootFragment(@NonNull ISupportFragment toFragment) {
        _mActivity.startRootFragment(toFragment);
    }

    /**
     * 启动fragment，并且不hide当前的fragment
     * @param toFragment    目标Fragment
     */
    public void startActRootFragmentWithoutHide(@NonNull ISupportFragment toFragment) {
        _mActivity.startRootFragmentWithoutHide(toFragment);
    }

    public void startWithoutHide(@NonNull ISupportFragment toFragment) {
        startWithType(toFragment, TransactionDelegate.TYPE_ADD_WITHOUT_HIDE);
    }
}
