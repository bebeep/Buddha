...
import me.yokeyword.fragmentation.scope.SingleTask;
import me.yokeyword.fragmentation.scope.SingleTop;
...
public class SupportActivityDelegate {
    ...
    public void start(ISupportFragment toFragment) {
        int launchMode = SupportHelper.parseLaunchMode(toFragment);
        start(toFragment, launchMode);
    }

    public void start(ISupportFragment fromFragment, ISupportFragment toFragment) {
        int launchMode = SupportHelper.parseLaunchMode(toFragment);
        start(fromFragment, toFragment, launchMode);
    }

    public void startWithType(ISupportFragment toFragment, int type) {
        int launchMode = SupportHelper.parseLaunchMode(toFragment);
        start(toFragment, launchMode, type);
    }
    ...
    public void start(ISupportFragment toFragment, @ISupportFragment.LaunchMode int launchMode, int type) {
     ...
     * 手动指定topFragment
     */
    public void start(ISupportFragment fromFragment, ISupportFragment toFragment, @ISupportFragment.LaunchMode int launchMode) {
        mTransactionDelegate.dispatchStartTransaction(getSupportFragmentManager(), fromFragment, toFragment, 0, launchMode, TransactionDelegate.TYPE_ADD);
    }
     ...
     * Start the target Fragment and pop itself
     */
    public void startWithPop(ISupportFragment fromFragment, ISupportFragment toFragment) {
        mTransactionDelegate.startWithPop(getSupportFragmentManager(), fromFragment, toFragment);
    }
    ...
    public void bindContainerId(int containerId, ISupportFragment to) {
        mTransactionDelegate.bindContainerId(containerId, to);
    }
}
