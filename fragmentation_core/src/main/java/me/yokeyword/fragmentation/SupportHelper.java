...
public class SupportHelper {
    ...
    public static int parseLaunchMode(ISupportFragment fragment) {
        Annotation[] annotations = fragment.getClass().getDeclaredAnnotations();
        for (Annotation annotation : annotations) {
            if (annotation instanceof SingleTask) {
                return ISupportFragment.SINGLETASK;
            } else if (annotation instanceof SingleTop) {
                return ISupportFragment.SINGLETOP;
            }
        }
