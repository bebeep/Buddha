...
public class Result {
    public static ArrayList<PhotoEntity> photos = new ArrayList<>();
     ...
     */
    public static int addPhoto(PhotoEntity photo) {
        if (photos.isEmpty()) {
            photo.selected = true;
            photos.add(photo);
            return ADD_SUCCESS;
    ...
    public static void removePhoto(PhotoEntity photo) {
     ...
     * @return 选择器应该显示的数字
     */
    public static String getSelectorNumber(PhotoEntity photo) {
