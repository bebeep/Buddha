...
public class AlbumBuilder {
     ...
     * @return AlbumBuilder
     */
    public AlbumBuilder setSelectedPhotos(ArrayList<PhotoEntity> selectedPhotos) {
     ...
     * @return AlbumBuilder
     */
    public AlbumBuilder setSelectedPhotos(ArrayList<PhotoEntity> selectedPhotos, boolean isSequentialSelectedPhotos) {
        Setting.selectedPhotos.clear();
    ...
    public AlbumBuilder setSelectedPhotoPaths(ArrayList<String> selectedPhotoPaths) {
        Setting.selectedPhotos.clear();
        ArrayList<PhotoEntity> selectedPhotos = new ArrayList<>();
        for (String path : selectedPhotoPaths) {
            ...
            PhotoEntity photo = new PhotoEntity(null, uri, path, 0, 0, 0, 0, 0, 0, null);
