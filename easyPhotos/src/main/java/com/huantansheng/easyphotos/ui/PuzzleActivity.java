...
public class PuzzleActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    public static void startWithPhotos(Activity act, ArrayList<PhotoEntity> photos,
    ...
    public static void startWithPhotos(Fragment fragment, ArrayList<PhotoEntity> photos,
                                       String puzzleSaveDirPath, String puzzleSaveNamePrefix,
                                       int requestCode, boolean replaceCustom,
                                       @NonNull ImageEngine imageEngine) {
        if (null != toClass) {
    ...
    public static void startWithPhotos(androidx.fragment.app.Fragment fragmentV,
                                       ArrayList<PhotoEntity> photos, String puzzleSaveDirPath,
    ...
    ArrayList<PhotoEntity> photos = null;
        ...
        stickerModel.save(this, mRootView, puzzleView, puzzleView.getWidth(),
                ...
                new SaveBitmapCallBack() {
                    ...
                    public void onSuccess(File file) {
                        ...
                        PhotoEntity photo = new PhotoEntity(file.getName(), UriUtils.getUri(PuzzleActivity.this,
