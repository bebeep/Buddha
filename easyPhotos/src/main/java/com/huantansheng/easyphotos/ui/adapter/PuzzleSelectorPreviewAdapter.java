...
public class PuzzleSelectorPreviewAdapter extends RecyclerView.Adapter {
    ...
    private ArrayList<PhotoEntity> dataList;
    private LayoutInflater mInflater;
    private OnClickListener listener;


    public PuzzleSelectorPreviewAdapter(Context cxt, ArrayList<PhotoEntity> dataList, OnClickListener listener) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        PhotoEntity photo = dataList.get(position);
