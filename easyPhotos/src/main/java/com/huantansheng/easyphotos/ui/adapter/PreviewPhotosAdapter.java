...
public class PreviewPhotosAdapter extends RecyclerView.Adapter<PreviewPhotosAdapter.PreviewPhotosViewHolder> {
    ...
    public PreviewPhotosAdapter(Context cxt, ArrayList<PhotoEntity> photos, OnClickListener listener) {
        this.photos = photos;
    ...
    @Override
    public void onBindViewHolder(@NonNull final PreviewPhotosViewHolder holder, final int position) {
        ...
        if (type.contains(Type.VIDEO)) {
            ...
            holder.ivPlay.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    LogUtil.e("photo:预览->"+photos.get(position));
