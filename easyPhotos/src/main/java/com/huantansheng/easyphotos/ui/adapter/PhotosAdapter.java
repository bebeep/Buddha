...
public class PhotosAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof PhotoViewHolder) {
            final PhotoEntity item = (PhotoEntity) dataList.get(p);
            if (item == null) return;
            ...
            if (Setting.showGif && isGif) {
                ...
                ((PhotoViewHolder) holder).v_alpha.setVisibility(View.GONE);
                ...
                ((PhotoViewHolder) holder).v_alpha.setVisibility(View.VISIBLE);
            ...
            ((PhotoViewHolder) holder).vSelector.setVisibility((Setting.showVideo && type.contains(Type.VIDEO))?View.GONE:View.VISIBLE);
            ((PhotoViewHolder) holder).tvSelector.setVisibility((Setting.showVideo && type.contains(Type.VIDEO))?View.GONE:View.VISIBLE);
            ((PhotoViewHolder) holder).ivPhoto.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!Result.isEmpty() && item.type.contains(Type.VIDEO)){
                        Toast.makeText(((PhotoViewHolder) holder).ivPhoto.getContext(), ((PhotoViewHolder) holder).ivPhoto.getContext().getString(R.string.selector_single_type_hint_easy_photos),Toast.LENGTH_SHORT).show();
                        return;
                    }
    ...
    private void singleSelector(PhotoEntity photo, int position) {
        if (!Result.isEmpty()) {
    ...
    private void updateSelector(TextView tvSelector, boolean selected, PhotoEntity photo, int position) {
        if (selected) {
    ...
    public static class PhotoViewHolder extends RecyclerView.ViewHolder {
        ...
        PhotoViewHolder(View itemView) {
            ...
            this.v_alpha = itemView.findViewById(R.id.v_alpha);
        }
    }
}
