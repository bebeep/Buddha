...
public class HolderFragment extends Fragment {
    ...
    public void startPuzzleWithPhotos(ArrayList<PhotoEntity> photos, String puzzleSaveDirPath, String puzzleSaveNamePrefix, boolean replaceCustom, @NonNull ImageEngine imageEngine, PuzzleCallback callback) {
            ...
            switch (requestCode) {
                case HOLDER_SELECT_REQUEST_CODE:
                    if (mSelectCallback != null) {
                        ArrayList<PhotoEntity> resultPhotos = data.getParcelableArrayListExtra(EasyPhotos.RESULT_PHOTOS);
